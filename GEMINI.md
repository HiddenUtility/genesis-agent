...
- **mktickets**: `Please understand the content of @WORKS/TASKS/fix_document.md, think about it, and execute it.`
- **mkreport** : `Please understand the content of @WORKS/TASKS/create_document.md, think about it, and execute it.`
- **fixreport**: `Please understand the content of @WORKS/TASKS/issue_ticket.md, think about it, and execute it.`
